package org.zys.jmeter.protocol.thrift.sampler;
...
public class ThriftSampler extends AbstractSampler {

    private static final Logger log = LoggerFactory.getLogger(ThriftSampler.class);

    public static final String HOST = "服务器名称或IP：";
    public static final String PORT = "端口：";
    public static final String CLASSNAME = "服务：";
    ...
    public SampleResult sample(Entry entry) {
        ...
        res.sampleStart();
        try {
            res.setResponseData(ThriftUtils.invoke(host, port, clsName, methodName, arguments.getArgumentsAsMap().values()), "UTF-8");
